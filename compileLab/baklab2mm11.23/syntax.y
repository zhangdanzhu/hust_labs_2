...
ExtDef : Specifier ExtDecList SEMI { 
			...
			if (!strcmp($1->l_child->lex_unit_name, "TYPE"))
			{
				if (!strcmp($1->l_child->id_type_name), "int")
				{
					insertvars0(0, $2);
				}
				else 
			...
			else if (!strcmp($1->l_child->lex_unit_name, "StructSpecifier")) 
			{
				insertstruct($1->l_child, $2);
			}
	     }
