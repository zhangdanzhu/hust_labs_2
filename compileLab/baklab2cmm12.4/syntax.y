...
%token <gt> SEMI COMMA ASSIGNOP RELOP
...
ExtDef : Specifier ExtDecList SEMI 
		 { 
		 	$$ = Create_Node(0, "ExtDef", 3, $1, $2, $3);
			DealExtDef(1, $1, $2, NULL);
	     }
	| Specifier SEMI  
	  { 
	      $$ = Create_Node(0, "ExtDef", 2, $1, $2);
		  DealExtDef(0, $1, NULL, NULL);
	  }
...
Dec: VarDec  { $$ = Create_Node(0, "Dec", 1, $1); } 
	| VarDec ASSIGNOP Exp  { $$ = Create_Node(0, "Dec", 3, $1, $2, $3); } 
	;

/* Expressions */
Exp: Exp ASSIGNOP Exp  { $$ = Create_Node(0, "Exp", 3, $1, $2, $3); } 
